...
final class JavaTextMessage_Check extends NLS {
	private static final String BUNDLE_NAME = JavaTextMessage_Check.class.getName();
	...
	static {
		NLS.initializeMessages(BUNDLE_NAME, JavaTextMessage_Check.class);
	}

	private JavaTextMessage_Check() {
	}
}
