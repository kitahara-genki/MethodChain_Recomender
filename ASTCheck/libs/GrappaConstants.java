...
public interface GrappaConstants
{
    ...
    */
    ...
    //--------------------------------------------------------------------
    /**
     * String name for head label attribute (arrowhead).
     */
    public final static String ARROWHEAD_ATTR       = "arrowhead";
    /**
     * String name for head label attribute (arrowtail).
     */
    public final static String ARROWTAIL_ATTR       = "arrowtail";
    /**
     * String name for fill color attribute (gradientangle).
     */
    public final static String GRADIENTANGLE_ATTR   = "gradientangle";
    ...
    //--------------------------------------------------------------------
    /**
     * Hash code for tip attribute (arrowhead).
     */
    public final static int ARROWHEAD_HASH      = ARROWHEAD_ATTR.hashCode();
    /**
     * Hash code for tip attribute (arrowtail).
     */
    public final static int ARROWTAIL_HASH       = ARROWTAIL_ATTR.hashCode();
    /**
     * Hash code for tip attribute (gradientangle).
     */
    public final static int GRADIENTANGE_HASH       = GRADIENTANGLE_ATTR.hashCode();
    ...
    // 追加-------------------------------------------------------------------
    public final static int ARROWHEAD_TYPE		= 0x0E;
    public final static int ARROWTAIL_TYPE		= 0x0F;
    //------------------------------------------------------------------------
    /*
     ...
     * Indicator that the element shape is determined by a user-supplied class defined by the "custom" attribute
     */
    public final static int STAR_SHAPE		= 29;
