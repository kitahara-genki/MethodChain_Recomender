	...
	Cloneable, Shape
{
	...
	case STAR_SHAPE:
		sides = 0;
		path.moveTo(x-1.5*width/4.0, y-1.5*height/10.0);
		path.lineTo(x-1.5*width/10.0, y-1.5*height/10.0);
		path.lineTo(x, y-1.5*width/4.0);
		path.lineTo(x+1.5*width/10.0, y-1.5*height/10.0);
		path.lineTo(x+1.5*width/4.0, y-1.5*height/10.0);
		path.lineTo(x+width/6.0, y+height/30.0);
		path.lineTo(x+3*width/10.0, y+1.3*height/4.0);
		path.lineTo(x, y+1.5*height/8.0);
		path.lineTo(x-3*width/10.0, y+1.3*height/4.0);
		path.lineTo(x-width/6.0, y+height/30.0);
		path.lineTo(x-1.5*width/4.0, y-1.5*height/10.0);
		break;
