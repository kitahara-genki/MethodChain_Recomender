	...
	Cloneable, ImageObserver, Shape, IGrappaObjectListener
{
    ...
    GradientPaint gradient = null;// 追加、グラデーション用
    int gradangle = 0;// 追加、グラデーションの角度
    ...
    public void updateDecoration() {
    	...
    	//gradient = (GradientPaint)(element.getAttributeValue(FILLCOLOR_ATTR));
